...
def get_financial_indicators(stock, **kw):
    data = {}   # A Dict mapping the indicator name to the data
    # I must iterate through kw because that tell me how many indicators to run
    for key, value in kw.items():
        # This uses dictionary comprehension to get all of the data
        temp = {key+' '+str(i) : func_dict[key](data=arg, DF=stock)
...
for ticker in portfolio:
    fin_data[ticker] = get_financial_indicators(portfolio[ticker], **indicators)